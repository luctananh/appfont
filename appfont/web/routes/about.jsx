...
export default function FontManager() {
        ...
        try {
            ...
            reader.onloadend = async () => {
                ...
                try {
                    ...
                    await handleCreateUpdateSelectfont(keyfont, null, response); // Cập nhật cài đặt font đã chọn sau khi upload, and pass the new created font data
    ...
    const handleSave = async () => {
        ...
        try {
             await uploadFileToGadget(file,"upload"); // Upload file lên Gadget API
